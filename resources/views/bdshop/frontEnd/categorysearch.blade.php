            ...
            <div class="row">
                <div class="col-md-12 col-xs-12">
                    <div class="mainbody-grid div_style4">
                        <h1 style="color:black">Search results for <span style="color:#008C3F">{{$search}}</span> </h1>
                ...
                <div class="div_style2">
                    <div class="row">
                        <div class="col-md-12 col-xs-12 div_style3 pt-4 pb-4">
                            <a href="{{route('info-category-all',$item->slug)}}" class="mt-4 mb-4" style="font-size:15px"> {{$item->name}}</a>
                        </div>
                    </div>
                </div>
                @endforeach
