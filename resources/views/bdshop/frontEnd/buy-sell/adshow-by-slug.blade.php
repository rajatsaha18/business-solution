            ...
            <div class="row p-3">
                <div class="col-md-6 col-sm-12">
                  <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                     <h6><i class="fa fa-bandcamp" aria-hidden="true"></i>
 {{$data->title}}
                  </h6>
                    </div>
                  </div>
                ...
                <div class="col-md-6 col-sm-12">
                    <form action="{{route('buysell.item.search')}}" method="GET" class="search-form">
                        @csrf
                        <div class="d-flex">
                            <input type="text" name="search" class="form-control" style="border-radius:20px" placeholder="What are you looking for?">
              ...
              <div class="col-md-6 col-sm-12">
                ...
                <style>
                 ...
                 <div class="slider item-c">
                  <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                    ...
                    @foreach($slideritems as $key=>$slider)
                ...
                <div class="item-card">
                  ...
                  <div class="pagination-block">
                    <span class="page-numbers current">{{$regularitems->links("pagination::bootstrap-4")}}</span>
                </div>
                </div>
              </div>
