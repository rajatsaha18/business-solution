            ...
            @csrf
                <div class="mb-3">
                    ...
                    <select name="property_type" id="" class="form-select @error('property_type') is-invalid @enderror">
                          ...
                          <option value="Building" {{$data_details->property_type =='Building'?'selected':''}}>Building</option>
                          <option value="Factory/Mil" {{$data_details->property_type =='Factory/Mil'?'selected':''}}>Factory/Mill</option>
                          <option value="Garage" {{$data_details->property_type =='Garage'?'selected':''}}>Garage</option>
                          <option value="Hotel" {{$data_details->property_type =='Hotel'?'selected':''}}>Hotel</option>
                          <option value="Office" {{$data_details->property_type =='Office'?'selected':''}}>Office</option>
                          <option value="Restaurant" {{$data_details->property_type =='Restaurant'?'selected':''}}>Restaurant</option>
                          <option value="Shop" {{$data_details->property_type =='Shop'?'selected':''}}>Shop</option>
                          <option value="Warehouse" {{$data_details->property_type =='Warehouse'?'selected':''}}>Warehouse</option>
                          <option value="Other" {{$data_details->property_type =='Other'?'selected':''}}>Other</option>
               ...
               <div class="mb-3 w-75">
                    ...
                    <input type="number" value="{{$data_details->size}}" class="form-control @error('size') is-invalid @enderror" name="size" placeholder="What's the size of you property">
                    @error('size')
                        <div class="text-danger">* {{ $message }}</div>
                      @enderror
                </div>
                  ...
                  <div>
                        <label class="pb-2">Unit</label>
                            <select name="land_unit" id="" class="form-select @error('land_unit') is-invalid @enderror">
                                ...
                                <option value="sqrt" {{$data_details-> land_unit =='sqrt'?'selected':''}}>sqrt</option>
                                <option value="khata" {{$data_details-> land_unit =='khata'?'selected':''}}>khata</option>
