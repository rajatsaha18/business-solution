     ...
     <section class="payment mt-5 mb-5" style="width:40%;display: block;margin:0 auto">
        <div class="container">
            <div class="card shadow">
                ...
                <div class="p-3">
                    <form action="{{route('buyselluser.user.ad.update.payment.id',$update_ad->id)}}" method="post">
                        @csrf
                        <div class="p-3"style="background-color: #F3F6F5!important;">
                            <div class="form-group">
                                ...
                                <select class="form-control mt-2 ad_show_pay" name="ad_show_type_id" required>
                                  <option value="">Choose...</option>
                                   ...
                                   <option value="{{$payment->id}}" {{$payment->id ==$update_ad->adShowType->id ?'selected':''}}>{{$payment->name}}</option>
                            ...
                            <div class="form-group mt-3">
                                ...
                                <input type="text" id="amount" class="form-control" name="amount" value="{{$update_ad->adShowType->price}}" placeholder="amount" readonly>
                            ...
                            <div class="form-group mt-3">
                                ...
                                <select class="form-control mt-2 payment_method_id" name="payment_method_id" required>
                                  <option value="">Choose...</option>
                                   ...
                                   <option value="{{$item->id}}" {{$item->id ==$update_ad->payment_method->id ?'selected':''}}>{{$item->name}}</option>
                            ...
                            <div class="form-group mt-3">
                                ...
                                <input type="text" id="number" class="form-control" name="number" value="{{$update_ad->payment_method->number}}" placeholder="Payment Number" readonly>
                                
                                
                            </div>
                            <div class="form-group mt-3">
                                <label for=""><strong>Your Transaction id</strong></label>
                                <input type="text" class="form-control" name="user_transaction_id" value="{{$update_ad->user_transaction_id}}" placeholder="Transaction id" required>
                                
                                
                            </div>
                        </div>
                        <div class="d-flex justify-content-center mt-3">
                            <button class="btn text-white" style="background-color: #118871;">Update</button>
                        </div>
                    </form>
