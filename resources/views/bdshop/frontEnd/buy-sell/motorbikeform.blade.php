            ...
            <form action="{{route('buyselluser.item.submit')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <div class="d-flex gap-5">
                        ...
                        <div>
                            <input type="radio" id="age11" name="bike_type" class="@error('bike_type') is-invalid @enderror" value="Motorcycle">
                            <label for="age11">Motorcycle</label><br>
                            <input type="radio" id="age12" name="bike_type" class="@error('bike_type') is-invalid @enderror" value="E-bikes">
                            <label for="age12">E-bikes</label><br>
                        </div>
                       <div>
                            <input type="radio" id="age13" name="bike_type" class="@error('bike_type') is-invalid @enderror" value="Scooters">
