...
<section class="blog ">
    <div class="container">
        <h3 class="iconColor fw-bolder">All Blogs</h3>
        <div class="d-flex se-input">
            <form action="{{route('halal.blog.search')}}" method="GET">
                <input type="text" placeholder="Search.." class="search-input p-2" name="search">
                <button class="fa-back" type="submit"><i class="fa fa-search" aria-hidden="true"></i>
                </button>
            </form>
        </div>
        <hr>
                ...
                <a href="{{route('halal.investment.blog.detail',$blog->slug)}}">
                    <div class="card shadow border-0 p-2">
                        <div class="card-title">
                            <img class="img-fluid" style="height: 300px" src="{{asset($blog->image)}}" alt="">
                        </div>
                        <div class="card-body">
