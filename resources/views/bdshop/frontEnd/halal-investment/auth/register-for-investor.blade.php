          ...
          <div class="row">
            <div class="col-md-4 col-sm-12">
              ...
              <h5 class="fw-bolder pt-2 pb-2">Assalamu Alaykum</h5>
                <p class="text-secondary fw-bolder">Join as an Investor</p>

                <form action="{{route('register.for.investor.submit')}}" method="POST">
                  @csrf
                  <div class="mb-3">
                    ...
                    <p class="pt-3">Already have an account? <a href="{{route('login.for.investor')}}" class="text-success">Login</a></p>
                </form>
