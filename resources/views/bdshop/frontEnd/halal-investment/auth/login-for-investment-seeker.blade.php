    ...
    <div class="row">
      <div class="col-md-4 col-sm-12">
        <div class="form-card card shadow border-0 p-3">
          ...
          <p class="text-secondary fw-bolder">Login For Investment Seeker</p>
          <form action="{{route('login.for.investment.seeker.submit')}}" method="POST">
            @csrf
            <div class="mb-3">
            ...
            <p class="pt-3">Don't have an account? <a href="{{route('register.for.investment.seeker')}}" class="text-success">Register</a></p>
          </form>
