...
<div class="container">
            ...
            <div class="row">
                <div class="col-md-12 col-xs-12">
                    <div class="mainbody-grid div_style4">
                        <h1 style="color:#00006b">Advanced Search </h1>
                ...
                <div class="width-100">
                    <h6 class="text-align:justify">
                        ...
                        <p style="color: #00006b;">To add your company in Business Solution Yellow Pages simply <a href="{{route('add-your-company')}}" class="text-bold" target="_blank">click
                                here</a>. For animation banner ad, please <a href="{{route('add-your-company')}}" target="_blank" class="text-bold">click
                                here</a>.</p>
                    </h6>
                </div>
                    ...
                    <div class="card p-5">
                        <form action="{{route('advance.search.result')}}" method="GET">
                            <div class="mb-3  row adv-search">
                                ...
                                <input class="col-md-8 col-sm-8 w-50 form-control" type="text" name="keyword" class="form-control" required>
                            </div>
                            <div class="mb-3  row adv-search">
                                <label class="col-md-4 col-sm-6 text-end">Country : </label>
                                <select class="form-control  col-md-8 col-sm-6 w-50 country js-example-basic-single" name="country_id" id="country_id" aria-label=".form-select-lg example" required>
                            ...
                            <div class="mb-3  row adv-search">
                                <label class="col-md-4 col-sm-6 text-end">State : </label>
                                <select class="form-control  col-md-8 col-sm-6 w-50 state js-example-basic-single" name="state_id" id="state_id" aria-label=".form-select-lg example" required>
                                    <option selected disabled>--select--</option>
                            ...
                            <div class="mb-3  row adv-search">
                                <label class="col-md-4 col-sm-6 text-end">City : </label>
                                <select class="form-control  col-md-8 col-sm-6 w-50 city js-example-basic-single" name="city_id" id="city_id" aria-label=".form-select-lg example" required>
                                    <option selected disabled>--select--</option>
                            ...
                            <div class="mb-3 d-flex justify-cotent-center">
                                ...
                                <button class="btn btn-outline-primary btn-sm col-md-8 col-sm-8 w-25">Search</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <div class="width-100 mainbody-grid text-justify border-top-dashed">
        <p>
            <img src="https://www.bdtradeinfo.com/public/assets/images/icon_keyword.png" alt="" height="20" width="20" class="margin-right-15 float-left">
            {{$item->keywords}}
        </p>
    </div>
</div>
