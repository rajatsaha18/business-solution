        ...
        <div class="col-md-8">
            ...
            @if ($errors->any())
                ...
                <div class="mainbody-grid div_style4 pt-0">
                    <h1 class="text-success">Add Product Form</h1>
                </div>
                <div class="main_content2">
                    </div>
                    <div class="clearfix"></div>

                    <form class="form-horizontal" action="{{route('user.product-info.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <table class="table-responsive table-bordered">
                            <tbody>
                                ...
                                <tr class="">
                                    ...
                                    <td class="text-left">
                                        <input class="form-control" type="text" name="title"
                                            id="organization" placeholder="Enter Your Product Name" value=""
                                            required="">
                                        <span class="text-danger"></span>
                                    </td>
                                </tr>
                                <tr class="">
                                    ...
                                    <td class="text-left">
                                        <input class="form-control" type="text" name="product_code"
                                            id="organization" placeholder="Enter Your Product Code(If any)" value="">
                                        <span class="text-danger"></span>
                                    </td>
                                </tr>
                                <tr class="">
                                ...
                                <tr class="">
                                    ...
                                    <td class="text-left">
                                        <input class="form-control" type="text" name="short_description" id="address"
                                            placeholder="Enter Short Info" value="">
                                        <span class="text-danger"></span>
                                    </td>
                                </tr>
                                <tr class="">
                                    ...
                                    <td class="text-left">
                                        <textarea id="summernote" type="text" name="long_description"></textarea>
                                        <span class="text-danger"></span>
                                    </td>
                                </tr>
                                <tr class="">
                                    ...
                                    <td class="text-left">
                                        <select name="price_type" id="" class="form-control" required>
                                ...
                                <tr class="">
                                    ...
                                    <td class="text-left">
                                        <input class="form-control" type="file" name="image" id="address" value="" required>
                                        <span class="text-danger"></span>
                                    </td>
                                </tr>
                                <tr>
