                    ...
                    <div class="col-md-9 col-xs-12 col-sm-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-xs-12 col-sm-6">
                                <div class="box4main" style="height: 200px">
                                    ...
                                    <div class="boxtext">
                                        <a style="color: #00006b;" href="{{route('info-product-details',$item->slug)}}"> {{ Str::limit($item->title, 20) }}
                                        </a><br>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-xs-6 col-sm-4 text-left margin-bottom-20 subc">
                                <a href="#"><img src="{{asset($item->icon)}}" alt="{{$item->name}}" title="Access Control"></a>
                                <a style="color: #00006b;" href="#">{{$item->name}}</a>
