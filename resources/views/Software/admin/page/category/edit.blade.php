...
@section('title')
    <title>{{ config('app.name', 'Laravel') }} | Footer Category</title>
@endsection
@section('content')
               ...
               <div class="col-8 offset-md-2">
                   <div class="card">
                       <div class="card-header">
                           ...
                           <a href="{{route('admin.footer-categories.index')}}" class="btn btn-primary float-right" >
                                Back
                           </a>
                       </div>
                       <div class="card-body">
                           <form action="{{route('admin.footer-categories.update',$category->id)}}" method="POST" enctype="multipart/form-data">
                               @csrf
                               @method('patch')
                               <div class="row">
