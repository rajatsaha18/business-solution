                    ...
                    <div class="card-body">
                        <form action="{{route('admin.page.update',$data->id)}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row col-md-12 mt-2">
                                ...
                                <div class="col-md-6">
                                    <label>Video</label>
                                    <input type="text" class="form-control" name="video" placeholder="Video Id">
                                </div>
                            </div>
                            <div class="col-md-12 mt-2">
                                <label>Link</label>
                            ...
                            <div class="row col-md-12 mt-2">
                                <div class="col-md-6">
                                    ...
                                    <input type="file" value="{{$data->brochure}}" class="form-control" name="brochure">
                                </div>
                                <div class="col-md-6">
                                    <label>User Manual</label>
                                    <input type="file" value="{{$data->user_manual}}" class="form-control" name="user_manual">
                                </div>
                            </div>
                            <div class="col-md-12 mt-2">
