...
@section('title')
<title>{{ config('app.name', 'Laravel') }} | Terms & Conditions</title>
@endsection
@section('content')
<!-- Content Wrapper. Contains Terms & Conditions content -->
<div class="content-wrapper">
    <!-- Content Header (Terms & Conditions header) -->
            ...
            <div class="col-10 offset-md-1">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{route('admin.terms.index')}}" class="btn btn-primary float-right">
                            Back
                        </a>
                    </div>
                    <div class="card-body">
