...
<style>
    @media (max-width: 576px) {
        ...
        .bg-cover {
            background-image: url('{{asset($sitebanner->terms_banner)}}') !important;
        ...
        <div class="row">
            <div class="col-12">
                <div class="breadcrumb_box text-center text-white">
                    <h2 class="breadcrumb-title text-white">Terms & Conditions</h2>
                    <!-- breadcrumb-list start -->
                    <ul class="breadcrumb-list">
                        <li class="breadcrumb-item"><a class=" text-white" href="{{ url('/') }}">Home</a></li>
                        <li class="active text-white">> Terms & Conditions </li>
                    </ul>
                    <!-- breadcrumb-list end -->
                </div>
            </div>
    ...
    <div class="contact-us-section-wrappaer section-space--pt_100 section-space--pb_70">
        <div class="container">
            <div class="row align-items-center ">
                <h2 class="text-center ">{{$terms->title}}</h2>
