...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="{{ asset('ui/frontend') }}/assets/images/favicon.webp">
...
<body>
    ...
    <!-- jQuery JS -->
    <script src="{{ asset('ui/frontend') }}/assets/js/vendor/jquery-3.5.1.min.js"></script>
    <script src="{{ asset('ui/frontend') }}/assets/js/vendor/jquery-migrate-3.3.0.min.js"></script>

    <!-- Bootstrap JS -->
    <script src="{{ asset('ui/frontend') }}/assets/js/vendor/bootstrap.min.js"></script>

    <!-- Plugins JS (Please remove the comment from below plugins.min.js for better website load performance and remove plugin js files from avobe) -->

    <script src="{{ asset('ui/frontend') }}/assets/js/plugins/plugins.min.js"></script>
