...
<div class="site-main">
    ...
    <section class="sidebar ttm-sidebar-right clearfix">
        ...
        <form action="{{route('hospital_blog_search')}}" method="GET">
        <div class="search-container">
            ...
            <div class="ttm-blog-classic-content">
                <div class="ttm-post-entry-header">
                    ...
                    <header class="entry-header">
                        <h2 class="entry-title"><a href="{{ route('home.single.blog.show', $blog->slug) }}" target="_blank">{{ $blog->short_description }}</a></h2>
                    </header>
                </div>
                <div class="entry-content">
                    ...
                    <div class="ttm-blogbox-desc-footer">
                        <div class="ttm-blogbox-footer-readmore">
                            <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-square ttm-btn-style-border ttm-icon-btn-right ttm-btn-color-black" href="{{ route('home.single.blog.show', $blog->slug) }}" title="">Read More <i class="ti ti-angle-double-right"></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="your-class">
                ...
                <div class="card mr-2" style="width: 18rem;">
                    <img class="img-fluid imageSize" src="{{ URL::to('/') }}/{{ $blog->image }}" alt="" target="_blank">
                    <div class="card-body">
                    <p class="card-text"><a href="{{ route('hospital.home.single.blog.show', $blog->slug) }}" target="_blank"><b>{{$blog->title}}</b></a></p>

                        <p class="card-text"><a href="{{ route('hospital.home.single.blog.show', $blog->slug) }}" target="_blank">{{ $blog->short_description }}</a></p>
