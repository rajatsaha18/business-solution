            ...
            <div class="col-md-12">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="breadcrumb-wrapper">
                        ...
                        <span class="ttm-textcolor-skincolor">{{$blog->title}}</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                    ...
                    <article class="post ttm-blog-classic clearfix">
                        ...
                        <div class="ttm-post-featured-wrapper ttm-featured-wrapper">
                            <div class="ttm-post-featured">
                                <img class="img-fluid" src="{{ URL::to('/') }}/{{ $blog->image }}" style="width:100%;" alt="">
                            </div>
                ...
                <div class="col-lg-3 sidebar-right widget-area">
                    ...
                    <aside class="widget widget-categories">
                        <h3 class="widget-title" style="background-color:#00006b!important">Categories</h3>
                        <ul>

                            @foreach ($blog_categories as $blog_cat)

                            <li><a href="{{route('hospital.show.blog.by.category',$blog_cat->slug)}}" target="_blank">{{$blog_cat->name}}</a><span>{{count($blog_cat->blogs)}}</span></li>
                    ...
                    <aside class="widget widget-recent-post">
                        <h3 class="widget-title" style="background-color:#00006b!important">Latest News</h3>
                        <ul class="widget-post ttm-recent-post-list">
                            @foreach ($blogs as $blog)
                            <li>
                                <a href="#"><img src="{{ URL::to('/') }}/{{ $blog->image }}" class="imageSize" alt="post-img"></a>
                                <span class="post-date">{{$carbon::parse($blog->created_at)->format('M-d-Y')}}</span>
                                <a href="{{route('hospital.home.single.blog.show',$blog->slug)}}" target="_blank">{{($blog->slug)}}....</a>
                            </li>
                            @endforeach
