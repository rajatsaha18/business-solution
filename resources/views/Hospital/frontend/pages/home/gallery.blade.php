...
<div class="ttm-page-title-row">
    ...
    <div class="mt-3 head-cat">
        <h3 class="text-center pt-2 pb-2 text-light" style="background-color:#0328AF;color:whtie">Gallery</h3>
        <div>
        </div><!-- page-title end-->
                                    ...
                                    <div class="col-md-4 col-sm-6 cat-cards text-center mb-3">
                                        ...
                                        <div class="card shadow">
                                            ...
                                            <div class="card-body prod-name" style="padding-top:20px">
                                                ...
                                                <h5 class="cat-a" style="font-size:16px;font-weight:600; color: #00006b;">{{$item->image_name}}</h5>
                                            </div>
                                        </div>
        ...
        <script>
            $(document).on("click", 'a[id^="item"]', function(event) {
                ...
                $.ajax({
                    url: "{{ route('hospital.find.gallery') }}",
                    method: "GET",
                    data: {
                        id: id
                    },
