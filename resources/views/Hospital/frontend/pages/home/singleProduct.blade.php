...
<div class="ttm-page-title-row">
    ...
    <div class="mt-3 head-cat">
        <h3 class="text-center  pt-4 pb-2" style="color:white;background-color:#0328AF">{{$product->title}}</h3>
        <div>
        </div><!-- page-title end-->
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                                        ...
                                        <div class="content-tab">
                                            ...
                                            <div class="content-inner">
                                                ...
                                                <p><strong>Payment Method Condition</strong>
                                                    ...
                                                    <strong>Online Payment</strong>: Applicable for any ordered amount as per company policy.
                                                </p>
                                                ...
                                                <p>
                                                    ...
                                                    These Terms of Service and any separate agreements whereby we provide you Services shall be governed by and construed and interpreted in accordance with the applicable laws governing eCommerce in Bangladesh. Any and all actionable legal claims or proceedings arising out of, or in connection to this website, must be brought within the jurisdiction of a competent Court in Bangladesh.
                                                </p>

                                                <p><strong>SECTION 5 – CHANGES TO TERMS OF SERVICE</strong>
                                                    We reserve the right, at our sole discretion, to update, change or replace any part of these Terms of Service by posting updates and changes to our website. It is your responsibility to check our website periodically for changes. Following the updates in eCommerce policies and laws at any respective time, we may change and update our terms and conditions anytime without prior notice.</p>
                                                </p>
                                            </div><!-- content-inner end-->
                                        </div>
                                    </div>
                         ...
                         <div>
            <p><i class="fa-solid fa-tag"></i> <b>Tag: </b> {{$product->meta_tag}}</p>
        </div>
                    </div>
            </section>
