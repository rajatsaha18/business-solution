                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-9 content-area">
                            <h6>We found <span class="text-success" style="font-weight:600;font-size:18px"></span> products available for you</h6>
                            <div class="row" style="padding-top:20px!important">
                                @foreach($serviceItems as $serviceItem)

                                <div class="col-md-4 col-sm-6 cat-cards text-center mb-3">
                                    <a href="{{route('hospital.single.service.show',$serviceItem->slug)}}">
                                        <div class="card pt-2 shadow">
                                            <div style="text-align:center;display:block;margin:0 auto">
                                                <img class="card-img-top" src="{{asset($serviceItem->frontend_image)}}" style="width:128.67px;height:128.67px;text-align:center;object-fit:contain" alt="Card image cap">
                                            </div>

                                            <div class="card-body prod-name" style="padding-top:20px">

                                                <a href="{{route('hospital.single.service.show',$serviceItem->slug)}}" class="cat-a" style="font-size:16px;font-weight:600;">{{$serviceItem->title}}</a>
                                            </div>
                                        </div>
                                    </a>
                                </div>
