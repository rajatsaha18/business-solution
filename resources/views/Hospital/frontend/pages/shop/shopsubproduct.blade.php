...
<div class="ttm-page-title-row">
    ...
    <div class="mt-3 head-cat">
        <h3 class="text-center  pt-2 pb-2" style="color:white;background-color:#0328AF">{{$subcategory_name->name}}</h3>
        <div>
        </div><!-- page-title end-->
                    ...
                    <div class="row">
                        <div class="col-lg-9 content-area">
                            ...
                            <div class="row" style="padding-top:20px!important">
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12  cat-cards text-center mb-3">
                        ...
                        <div class="col-lg-3 sidebar-right widget-area">
                            ...
                            <aside class="widget widget-categories">
                                <h3 class="widget-title" style="background-color:#0328AF">Related SubCategories</h3>
                                <ul>

                                    @foreach ($related_subcategories as $cat)


                                    <li><a href="{{route('hospital.show.product.by.subcategory',$cat->slug)}}" target="_blank">{{$cat->name}}</a><span>{{count($cat->product)}}</span></li>
