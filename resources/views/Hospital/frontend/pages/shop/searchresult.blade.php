                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-6 cat-cards text-center mb-3">
                                        <a href="{{route('hospital.single.service.show',$item->slug)}}">
                                            <div class="card shadow">
                                                <div style="text-align:center;display:block;margin:0 auto">
                                                    <img class="card-img-top imageSize" src="{{asset($item->frontend_image)}}" alt="Card image cap">
                                                </div>

                                                <div class="card-body prod-name" style="padding-top:20px">

                                                    <a href="{{route('hospital.single.service.show',$item->slug)}}" class="text-dark cat-a" style="font-size:16px;font-weight:600;">{{$item->title}}</a>
                                                </div>
                                            </div>
                                        </a>
                                    </div>
