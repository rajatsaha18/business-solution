...
<div class="ttm-page-title-row">
    ...
    <div class="mt-3 head-cat">
        <h3 class="text-center pt-2 pb-2" style="color:white;background-color:#1FA8DE">{{$category->name}}</h3>
        <div>
        </div><!-- page-title end-->
                        ...
                        <div class="col-lg-3 sidebar-right widget-area">
                            ...
                            <aside class="widget widget-categories">
                                ...
                                <ul>
                                    ...
                                    <li><a href="{{route('hospital.show.product.by.category',$cat->slug)}}" target="_blank">{{$cat->name}}</a><span>{{count($cat->product)}}</span></li>
