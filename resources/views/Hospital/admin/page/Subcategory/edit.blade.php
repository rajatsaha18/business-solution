            ...
            <div class="col-10 offset-md-1">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{route('admin.hospital-sub-categories.index')}}" class="btn btn-primary float-right">
                            Back
                        </a>
                    </div>
                    <div class="card-body">
                        <form action="{{route('admin.hospital-sub-categories.update',$data->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('patch')
