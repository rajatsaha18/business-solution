           ...
           <div class="row">
               <div class="col-10 offset-md-1">
                   <div class="card">
                       ...
                       <div class="card-body">
                           <form action="{{route('admin.hospital-design.update',$data->id)}}" method="POST" enctype="multipart/form-data">
                               @csrf
                               @method('patch')
                               <div class="col-md-12 mt-2">
                                ...
                                <div class="col-md-12 mt-2">
                                    ...
                                    <textarea class="form-control" id="summernote" value="{{$data->description}}" name="description"></textarea>
