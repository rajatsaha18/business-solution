        ...
        <div class="row">
            <div class="col-10 offset-md-1">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('admin.hospital-page.update',$data->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('patch')
                            <div class="row">
                                <div class="col-md-12 mt-2">
                                    ...
                                    <select name="category_id" id="" class="form-control">
                                        ...
                                        <option value="{{$item->id}}" @if($item->id == $data->hospital_category_id) selected @endif>{{$item->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-12 mt-2">
                                ...
                                <div class="col-md-12 mt-2">
                                    ...
                                    <textarea type="text" id="editor1" class="form-control" name="description" placeholder="Description">{!! $data->description !!}</textarea>
                                </div>
                                <div class="col-md-12 mt-2">
