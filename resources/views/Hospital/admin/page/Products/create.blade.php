        ...
        <div class="row">
            <div class="col-10 offset-md-1">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('admin.hospital-product.store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="col-md-12 mt-2">
                                <label>Origin</label>
                                <input type="text" name="origin" class="form-control" placeholder="Origin"></input>
                            ...
                            <div class="col-md-12 mt-2">
                                ...
                                <textarea name="long_description" id="summernote" type="text" class="form-control"></textarea>
