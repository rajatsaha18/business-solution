        ...
        <div class="row">
            <div class="col-10 offset-md-1">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('admin.hospital-news.store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-12 mt-2">
                                    ...
                                    <textarea type="text" id="editor1" class="form-control" name="long_description" placeholder="Long Description"></textarea>
                                </div>
                                <div class="col-md-12 mt-2">
