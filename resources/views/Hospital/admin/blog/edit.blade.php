        ...
        <div class="row">
            <div class="col-10 offset-md-1">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('admin.hospital-blog.update',$data->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('patch')
                            <div class="row">
                                <div class="col-md-12 mt-2">
                                    ...
                                    <select name="category_id" id="" class="form-control">
                                        ...
                                        <option value="{{$item->id}}" @if($data->hospital_category_id == $item->id) selected @endif>{{$item->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-12 mt-2">
                                ...
                                <div class="col-md-12 mt-2">
                                    ...
                                    <textarea type="text" id="summernote" class="form-control" name="long_description" placeholder="Description">{!! $data->long_description !!}</textarea>
                                </div>
                                <!--<div class="col-md-12 mt-2">-->
                                <!--    <label>Long Description</label>-->
                                <!--    <textarea type="text" id="editor1" class="form-control" name="long_description" placeholder="Long Description">{!! $data->long_description !!}</textarea>-->
                                <!--</div>-->
                                <div class="col-md-12 mt-2">
