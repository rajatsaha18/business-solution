        ...
        <div class="prn">
           ...
           <div class="prlie ">
            ...
            <p class="prp">
                ...
                <a href="{{ route('show.product.by.category',$product->category->slug ??'') }}">{{ $product->category->name??'' }}</a>
            ...
            <a href="{{ route('home.single.product.show',$product->slug) }}" class="prtu">
                ...
                <picture>
                    ...
                    <img data-original="{{ asset($product->frontend_image) }}"
                        title="{{ $product->title }}" alt="{{ $product->title }}" class="nlazy" style="width:197px;height:197px">
