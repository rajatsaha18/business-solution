...
<div class="fenbanner mat1">
    ...
    <p class="fenbiao">{{ $subcategory_name->name }}</p>
            ...
            @foreach ($products as $product)
                <div class="prlie">
                    ...
                    <p class="prp">
                        ...
                        <a href="{{ route('home.single.product.show',$product->slug) }}">{{ $product->short_description }}</a>
                    ...
                    <a href="{{ route('home.single.product.show',$product->slug) }}" class="prtu">
                        ...
                        <picture>
                            ...
                            <source type="image/webp"
                                srcset="{{ asset($product->frontend_image) }}">

                            <img data-original="{{ asset($product->frontend_image) }}"
                                title="{{ $product->title }}" alt="{{ $product->title }}" class="nlazy" style="width:210px;height:210px">
