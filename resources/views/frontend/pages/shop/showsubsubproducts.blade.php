...
@section('content')
 ...
 <div class="ttm-page-title-row">
    ...
    <div class="mt-3 head-cat">
        <h3 class="text-center bg-success pt-2 pb-2" style="color:white;background-color:#0490D2">{{$subsubcategory_name->name}}</h3>
    <div>
</div><!-- page-title end-->
            ...
            <div class="row">
                ...
                <div class="col-lg-3 sidebar-right widget-area">
                    ...
                    <aside class="widget widget-categories">
                        <h3 class="widget-title">Related Sub SubCategories</h3>
                        <ul>
