...
@section('content')
 ...
 <div class="ttm-page-title-row">
    ...
    <div class="mt-3 head-cat">
        <h3 class="text-center pt-2 pb-2" style="color:white;background-color:#00B0E2">{{$category->name}}</h3>
    <div>
</div><!-- page-title end-->
            ...
            <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6 cat-cards text-center mb-3">
                        ...
                        <div class="card pt-2 shadow">
                            ...
                            <div class="card-body prod-name" style="padding-top:20px">
                              ...
                              <a href="{{route('home.single.product.show',$product->slug)}}" class="cat-a" style="font-size:16px;font-weight:600;">{{$product->title}}</a>
                            </div>
                          </div>
                        </a>
                    </div>
                ...
                <div class="col-lg-3 sidebar-right widget-area">
                    ...
                    <aside class="widget widget-categories">
                        <h3 class="widget-title" style="background-color:#00B0E2">All Categories</h3>
                        <ul>
