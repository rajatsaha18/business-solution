...
<!--Horizontal Form-->
                    <!--===================================================-->
                    <form class="form-horizontal" action="{{ route('admin.advertise-post.update',$data->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('patch')
                        <div class="card-body">
                            ...
                            <div class="col-md-12 mt-2">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" placeholder="{{__('Owner Name')}}" name="owner_name" value="{{$data->owner_name}}" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-12 mt-2">
                            ...
                            <div class="col-md-12 mt-2">
                                ...
                                <div class="col-sm-12">
                                    <?php 
                                        $state_name=DB::table('states')->where('id',$data->state_id)->first();
                                        $city=DB::table('cities')->where('id',$data->city_id)->first();
                                    ?>
                                    <select name="state_id" class="form-control  state js-example-basic-single" >
                                        <option value="" selected disabled>--select--</option>
                                        {{-- @foreach ($states as $item) --}}
                                            <option value="{{isset($data->state_id)?$data->state_id:''}}" selected>{{isset($state_name->name)?$state_name->name:''}}</option>
                                        {{-- @endforeach --}}
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-12">
                                    <select name="city_id"  class="form-control  city js-example-basic-single" >
                                        ...
                                        {{-- @foreach ($cities as $item) --}}
                                            <option value="{{isset($data->city_id)?$data->city_id:''}}" selected>{{isset($city->name)?$city->name:''}}</option>
                                        {{-- @endforeach --}}
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12 mt-2">
                            ...
                            <div class="col-sm-12">
                                <textarea name="about" type="text" class="form-control summernote">{!!   $data->about ?? ''   !!}</textarea>
                            </div>
                        </div>
                        <div class="col-md-12 mt-2">
                            <label class="col-sm-2 control-label" for="name">Founded Date</label>
                            <div class="col-sm-12">
                                <input type="text" class="form-control" name="founded_date" placeholder="1989" value="{{$data->founded_date}}"></input>
                            </div>
                        </div>
                        <div class="col-md-12 mt-2">
                            <label class="col-sm-2 control-label" for="name">Operating Status</label>
                            <div class="col-sm-12">
                                <input type="text" class="form-control" name="operating_status" value="{{$data->operating_status??''}}"></input>
                            </div>
                        </div>
                        <div class="col-md-12 mt-2">
                            <label class="col-sm-2 control-label" for="name">Total Employee</label>
                            <div class="col-sm-12">
                                <input type="text" class="form-control" name="total_employee" value="{{$data->total_employee??''}}"></input>
                            </div>
                        </div>
                        <div class="col-md-12 mt-2">
                            <label class="col-sm-2 control-label" for="name">Total Funding Amount</label>
                            <div class="col-sm-12">
                                <input type="text" class="form-control" name="total_funding_amount" value="{{$data->total_funding_amount??''}}"></input>
                            </div>
                        </div>
                        <div class="col-md-12 mt-2">
                            <label class="col-sm-2 control-label" for="name">Investment Detail</label>
                            <div class="col-sm-12">
                                <textarea name="investments" type="text" class="form-control summernote">{!!   $data->investments        !!}</textarea>
                            </div>
                        </div>
                        <div class="col-md-12 mt-2">
                            <label class="col-sm-2 control-label" for="name">Funding Detail</label>
                            <div class="col-sm-12">
                                <textarea name="funding_details" type="text" class="form-control summernote">{!!   $data->funding_details    !!}</textarea>
                            </div>
                        </div>
                            <div class="row mt-2">
                                <div class="col-md-12">
