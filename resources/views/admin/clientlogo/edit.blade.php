...
@section('title')
    <title>{{ config('app.name', 'Laravel') }} | Client Logo</title>
@endsection
@section('content')
               ...
               <div class="col-10 offset-md-1">
                   <div class="card">
                       <div class="card-header">
                           ...
                           <a href="{{route('admin.client-logo.index')}}" class="btn btn-primary float-right" >
                                Back
                           </a>
                       </div>
                       <div class="card-body">
                           <form action="{{route('admin.client-logo.update',$data->id)}}" method="POST" enctype="multipart/form-data">
                               @csrf
                               @method('patch')
                               <div class="row">
                                ...
                                <div class="col-md-12 mt-2">
                                    <label>Company Link <span style="color: red">*</span> </label>
                                    <input type="text" class="form-control" name="link" value="{{$data->link}}" placeholder="Link" required>
                                </div>
                                <div class="col-md-12 mt-2">
                                    <label>Logo </label>
                                    <img src="{{asset($data->logo)}}" alt="" width="60px">
