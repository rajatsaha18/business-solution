        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item has-treeview menu-open">
                    <a href="{{ route('admin.newsletter.send') }}" class="nav-link">
                        <i class="nav-icon fas fa-tachometer-alt"></i>
                        <p>
                            Sending NewsLetter
                        </p>
                ...
                <li
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.product-contact.index') }}"
                                class="nav-link {{ request()->is('admin/product-contact') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Product Contact</p>
                            </a>
                        </li>
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.product-features.index') }}"
                                class="nav-link {{ request()->is('admin/product-features') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Core Features</p>
                            </a>
                        </li>
                ...
                <li class="nav-item {{ request()->is('admin/page-categories') ? 'active' : '' }}">
                ...
                <li class="nav-item
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.top-products.index') }}"
                                class="nav-link {{ request()->is('admin/top-products') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Products</p>
                            </a>
                        </li>
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        {{-- <li class="nav-item">
                            <a href="{{ route('admin.about-page.index') }}"
                                class="nav-link {{ request()->is('admin/about-page') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>About Page Setup</p>
                            </a>
                        </li> --}}
                        

                        {{-- <li class="nav-item">
                            <a href="{{ route('admin.who-we-are.index') }}"
                                class="nav-link ">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Who we are</p>
                            </a>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.who-we.index') }}"
                                class="nav-link {{ request()->is('admin/who-we') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Who-We</p>
                            </a>
                        </li>
                        ...
                        {{-- <li class="nav-item">
                            <a href="{{ route('admin.pricing-category.index') }}"
                                class="nav-link {{ request()->is('admin/pricing-category') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
