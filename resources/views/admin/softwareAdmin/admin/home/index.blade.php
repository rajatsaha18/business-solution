                                    ...
                                    <div class="tab-pane active show text-left fade" id="vert-tabs-home" role="tabpanel" aria-labelledby="vert-tabs-home-tab">
                                        <form action="{{route('admin.home-setup.store')}}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="col-md-12 mt-2">
                                                ...
                                                <textarea type="text" name="what_we_do_description" class="form-control">{{$setting->what_we_do_description ?? ''}}</textarea>
                                            </div>
                                            <div class="col-md-12 mt-2">
                                                ...
                                                @if(!empty($setting->what_we_do_image))
                                                 ...
                                                 <?php
                                                 $youtube=explode('=',$setting->what_we_do_image);
                                                 $ytube=$youtube[1];
                                                ?>
                                                
                                               
                                                <iframe height="100px" width="300px"src="https://www.youtube.com/embed/{{$ytube}}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                                @endif
                                    ...
                                    <div class="tab-pane fade" id="vert-tabs-profile" role="tabpanel" aria-labelledby="vert-tabs-profile-tab">
                                        <form action="{{route('admin.home-setup.store')}}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 mt-2">
                                                    <label>About </label>
                                                    <input type="text" class="form-control" value="{{$setting->about ?? ''}}" name="about">
                                                </div>
                                                <div class="col-md-12 mt-2">
