...
@section('title')
    <title>{{ config('app.name', 'Laravel') }} | Team Page SEO</title>
@endsection
@section('content')
               ...
               <div class="row mb-2">
                   ...
                   <div class="col-sm-6">
                       <ol class="breadcrumb float-sm-right">
                           ...
                           <li class="breadcrumb-item active">Team Page Seo</li>
                       </ol>
                   </div>
               </div>
           </div>
               ...
               <div class="col-10 offset-md-1">
                   <div class="card">
                       <div class="card-header">
                           <h3 class="card-title">Team Page SEO</h3>
                          
                       </div>
                       <div class="card-body">
                           <form action="{{route('admin.team-page-seo.store')}}" method="POST" enctype="multipart/form-data">
                               @csrf
