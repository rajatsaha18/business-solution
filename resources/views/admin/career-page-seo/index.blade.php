...
@section('title')
    <title>{{ config('app.name', 'Laravel') }} | Career Page SEO</title>
@endsection
@section('content')
    ...
    <div class="content-wrapper">
       ...
       <section class="content-header">
           <div class="container-fluid">
               <div class="row mb-2">
                   <div class="col-sm-6">
                       <h1>Career Page SEO</h1>
                   </div>
                   <div class="col-sm-6">
                       <ol class="breadcrumb float-sm-right">
                           <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Home</a></li>
                           <li class="breadcrumb-item active">Career Page Seo</li>
                       </ol>
                   </div>
               </div>
           </div>
               ...
               <div class="col-10 offset-md-1">
                   <div class="card">
                       <div class="card-header">
                           <h3 class="card-title">Career Page SEO</h3>
                          
                       </div>
                       <div class="card-body">
                           <form action="{{route('admin.career-page-seo.store')}}" method="POST" enctype="multipart/form-data">
                               @csrf
