                    ...
                    <div class="card-body">
                        <form action="{{route('admin.about.update',['id' => $about->id])}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea name="description" id="summernote" class="form-control" placeholder="Description">{{$about->description}}</textarea>
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <img src="{{asset($about->image)}}" alt="" height="80px" width="90px" />
                            </div>
