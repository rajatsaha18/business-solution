                           ...
                           <form action="{{route('admin.project.update',$data->id)}}" method="POST" enctype="multipart/form-data">
                               ...
                               <div class="row">
                                <div class="col-md-12 mt-2">
                                    ...
                                    <select name="project_category_id" id="" class="form-control">
                                ...
                                <div class="col-md-12 mt-2">
                                    ...
                                    <textarea type="text" class="form-control" id="summernote" name="description" placeholder=" Description">{!! $data->description !!}</textarea>
                                </div>
                                <div class="col-sm-6">
