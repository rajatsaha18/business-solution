...
@section('title')
    <title>{{ config('app.name', 'Laravel') }} | Contact Page SEO</title>
@endsection
@section('content')
               ...
               <div class="col-10 offset-md-1">
                   <div class="card">
                       <div class="card-header">
                           <h3 class="card-title">Contact Page SEO</h3>
                          
                       </div>
                       <div class="card-body">
                           <form action="{{route('admin.contact-page-seo.store')}}" method="POST" enctype="multipart/form-data">
                               @csrf
