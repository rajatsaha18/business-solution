                           ...
                           <form action="{{route('admin.pricing-plan.store')}}" method="POST" enctype="multipart/form-data">
                               ...
                               <div class="row">
                                   ...
                                   <div class="col-md-12 mt-2">
                                    ...
                                    <input type="number" class="form-control" name="monthly_price" placeholder="Monthly Price">
                                    </div>
                                    <div class="col-md-12 mt-2">
                                        <label>Yearly Price</label>
                                        <input type="number" class="form-control" name="yearly_price" placeholder="Yearly Price">
                                    </div>
                                    <div class="col-sm-6">
