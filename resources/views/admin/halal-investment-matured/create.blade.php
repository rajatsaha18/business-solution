    ...
    <div class="content-wrapper">
       ...
       <section class="content-header">
           <div class="container-fluid">
               <div class="row mb-2">
                   <div class="col-sm-6">
                       <h1>Halal Investmetn Matured Investment</h1>
                   </div>
                   <div class="col-sm-6">
           ...
           <div class="row">
               <div class="col-10 offset-md-1">
                   <div class="card">
                       ...
                       <div class="card-body">
                           <form action="{{route('admin.halal-investment-matured.store')}}" method="POST" enctype="multipart/form-data">
                               @csrf
                               <div class="row">
                                ...
                                <div class="col-md-12 mt-2">
                                    ...
                                    <input type="text" class="form-control" name="total_repaid" required>
                                </div>
