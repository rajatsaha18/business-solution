...
class HomePageWhoWeController extends Controller
{
    /**
    ...
    {
        //
        $data=HomePageWhoWeAre::first();
        return view('admin.homeWhoWe.index',compact('data'));
    }
