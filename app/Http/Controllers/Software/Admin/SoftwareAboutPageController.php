...
use App\Models\SoftwareAboutPage;
use App\Http\Controllers\Controller;

class SoftwareAboutPageController extends Controller
{
    
    public function index()
    {
        $data=SoftwareAboutPage::first();
        return view('Software.admin.about-us-page.index',compact('data'));
    ...
    {
        $sitesetting = SoftwareAboutPage::first();
        if($sitesetting){
            ...
            $sitesetting=new SoftwareAboutPage();
            $sitesetting->title = $request->title;
            $sitesetting->about_us = $request->about_us;
            $sitesetting->why_choose_us = $request->why_choose_us;
            $sitesetting->mission = $request->mission;
