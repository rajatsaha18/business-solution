...
class SoftwareBlogController extends Controller
{
    
    public function index()
    {
        $blogs = SoftwareBlog::orderBy('id','desc')->get();
    ...
    {
        $categories = SoftwareBlogCategory::where('status',1)->get();
    ...
    {
        $categories = SoftwareBlogCategory::where('status',1)->get();
        $data = SoftwareBlog::findOrFail(decrypt($id));
