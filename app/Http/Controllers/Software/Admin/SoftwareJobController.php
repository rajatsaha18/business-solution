...
class SoftwareJobController extends Controller
{
    /**
    ...
    {
        $jobs = SoftwareJob::orderBy('id','desc')->get();
        return view('Software.admin.job.index',compact('jobs'));
    }
    ...
    {
        return view('Software.admin.job.create');
    }
    ...
    {
        $data = SoftwareJob::findOrFail(decrypt($id));
        return view('Software.admin.job.edit',compact('data'));
    }
    ...
    public function applied_job(){
        $applied_jobs = SoftwareJobApplied::orderBy('id','desc')->get();
