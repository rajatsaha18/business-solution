...
class HospitalBannerController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $data = HospitalBanner::find(1);
        return view('Hospital.admin.page.Banner.index', compact('data'));
    }
    ...
    {
        //
        $data = HospitalBanner::findOrFail(1);
        return view('Hospital.admin.page.Banner.create', compact('data'));
    }
    ...
    public function bannerUpdate(Request $request)
    {
        ...
        if ($banner) {
            ...
            if ($banner_one) {
                ...
                if ($success) {
                    if (file_exists($banner->banner_one) && !empty($banner->banner_one)) {
            ...
            if ($banner_two) {
                ...
                // $img = Image::make($image_url)->resize(400, 200)->save();
                if ($success) {
                    if (file_exists($banner->banner_two)  && !empty($banner->banner_two)) {
            ...
            if ($banner_three) {
                ...
                // $img = Image::make($image_url)->resize(400, 200)->save();
                if ($success) {
                    if (file_exists($banner->banner_three) && !empty($banner->banner_three)) {
            ...
            if ($banner_four) {
                ...
                // $img = Image::make($image_url)->resize(400, 200)->save();
                if ($success) {
                    if (file_exists($banner->banner_four) && !empty($banner->banner_four)) {
            ...
            if ($banner_five) {
                ...
                // $img = Image::make($image_url)->resize(400, 200)->save();
                if ($success) {
                    if (file_exists($banner->banner_five) && !empty($banner->banner_five)) {
            ...
            if ($banner_six) {
                ...
                // $img = Image::make($image_url)->resize(400, 200)->save();
                if ($success) {
                    if (file_exists($banner->banner_six) && !empty($banner->banner_six)) {
            ...
            if ($banner_seven) {
                ...
                // $img = Image::make($image_url)->resize(400, 200)->save();
                if ($success) {
                    if (file_exists($banner->banner_seven) && !empty($banner->banner_seven)) {
    ...
    {
        //
        $data = HospitalBanner::findOrFail(decrypt($id));
        return view('Hospital.admin.page.Banner.edit', compact('data'));
    }
    ...
    {
        //
        $banner = HospitalBanner::findOrFail($id);
